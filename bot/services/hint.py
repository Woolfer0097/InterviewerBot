...
Формат ответа: 
1. Сначала подсказка (без префиксов типа "Подсказка:" или "Совет:")
2. Затем эталонный ответ, который должен быть обернут в символы || в начале и конце, например: ||эталонный ответ||

Важно: эталонный ответ должен быть полностью внутри символов ||, без пробелов между || и текстом ответа.
"""
